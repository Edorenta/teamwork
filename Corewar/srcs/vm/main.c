...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/12 13:29:40 by jjourne           #+#    #+#             */
/*   Updated: 2018/06/12 13:41:55 by jjourne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_vm(t_vm *vm)
{
	...
	vm->dump = -1;//dump de la memoire (option -d) =>inactive par defaut
...
int		main(int argc, char *argv[])
{
	...
	init_vm(&vm);
	if(check_args(&vm, argc, argv)) //si check_args return 1, error
